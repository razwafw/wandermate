...
INSERT INTO packages (id, name, subtitle, price, group_size, duration, location, start_location, end_location,
                      accomodation,
                      description, highlights, includes, excludes, itinerary)
VALUES (1001, 'Bali Adventure', 'Explore Bali', 4500, 10, '3 days', 'Bali', 'Denpasar', 'Ubud', 'Hotel',
       ...
       (1002, 'Yogyakarta Heritage', 'Culture & History', 2560, 8, '2 days', 'Yogyakarta', 'Yogyakarta', 'Borobudur',
       ...
       (1003, 'Lombok Escape', 'Nature & Relax', 4800, 12, '3 days', 'Lombok', 'Mataram', 'Gili Trawangan', 'Resort',
       ...
       (1004, 'Komodo Expedition', 'Wildlife Adventure', 10500, 15, '4 days', 'Komodo', 'Labuan Bajo', 'Komodo Island',
       ...
       (1005, 'Bandung Culinary', 'Food & Fun', 1500, 6, '2 days', 'Bandung', 'Bandung', 'Lembang', 'Hotel',
        'Taste Bandung', 'Street Food\nMarkets\nCoffee Shops', 'Guide\nMeals\nTransport', 'Drinks\nPersonal expenses',
        'Day 1: Food Tour | Explore Bandung street food\nDay 2: Lembang | Visit Lembang and local markets'),
       (1006, 'Jakarta City Tour', 'Urban Experience', 2400, 20, '1 day', 'Jakarta', 'Jakarta', 'Jakarta', 'Hotel',
        'Explore Jakarta', 'Monas\nKota Tua\nShopping Malls', 'Guide\nTickets\nTransport', 'Meals\nPersonal expenses',
        'Day 1: City Tour | Visit Monas, Kota Tua, and malls'),
       (1007, 'Raja Ampat Diving', 'Underwater Paradise', 9600, 8, '5 days', 'Raja Ampat', 'Sorong', 'Waisai', 'Resort',
       ...
       (1008, 'Sumatra Wildlife', 'Jungle Trek', 3500, 10, '3 days', 'Sumatra', 'Medan', 'Bukit Lawang', 'Lodge',
       ...
       (1009, 'Bromo Sunrise', 'Mountain Adventure', 4480, 16, '2 days', 'Bromo', 'Malang', 'Bromo', 'Hotel',
        'Climb Bromo', 'Sunrise View\nJeep Tour\nCrater Hike', 'Guide\nTransport\nBreakfast',
        'Meals\nPersonal expenses',
        'Day 1: Sunrise Tour | Early morning jeep to Bromo\nDay 2: Crater Hike | Hike to Bromo crater and return'),
       (1010, 'Labuan Bajo Leisure', 'Island Hopping', 8400, 14, '3 days', 'Labuan Bajo', 'Labuan Bajo', 'Padar Island',
