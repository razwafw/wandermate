...
INSERT INTO packages (id, name, subtitle, price, duration, location, start_location, end_location, accomodation,
                      description, highlights, includes, excludes, itinerary)
VALUES (1001, 'Bali Adventure', 'Explore Bali', 2500000, '3 days', 'Bali', 'Denpasar', 'Ubud', 'Hotel',
       ...
       (1002, 'Yogyakarta Heritage', 'Culture & History', 1800000, '2 days', 'Yogyakarta', 'Yogyakarta', 'Borobudur',
        'Guesthouse', 'Discover Yogyakarta', 'Borobudur\nPrambanan\nMalioboro', 'Guide\nTickets\nBreakfast',
        'Lunch\nPersonal expenses',
        'Day 1: City Tour | Explore Yogyakarta city\nDay 2: Temple Tour | Visit Borobudur and Prambanan'),
       (1003, 'Lombok Escape', 'Nature & Relax', 2200000, '3 days', 'Lombok', 'Mataram', 'Gili Trawangan', 'Resort',
       ...
       (1004, 'Komodo Expedition', 'Wildlife Adventure', 3500000, '4 days', 'Komodo', 'Labuan Bajo', 'Komodo Island',
        'Boat', 'See Komodo dragons', 'Komodo Island\nPink Beach\nPadar Island', 'Boat\nMeals\nGuide',
        'Flights\nEntrance fees',
       ...
       (1005, 'Bandung Culinary', 'Food & Fun', 1500000, '2 days', 'Bandung', 'Bandung', 'Lembang', 'Hotel',
        'Taste Bandung', 'Street Food\nMarkets\nCoffee Shops', 'Guide\nMeals\nTransport', 'Drinks\nPersonal expenses',
        'Day 1: Food Tour | Explore Bandung street food\nDay 2: Lembang | Visit Lembang and local markets'),
       (1006, 'Jakarta City Tour', 'Urban Experience', 1200000, '1 day', 'Jakarta', 'Jakarta', 'Jakarta', 'Hotel',
        'Explore Jakarta', 'Monas\nKota Tua\nShopping Malls', 'Guide\nTickets\nTransport', 'Meals\nPersonal expenses',
        'Day 1: City Tour | Visit Monas, Kota Tua, and malls'),
       (1007, 'Raja Ampat Diving', 'Underwater Paradise', 5000000, '5 days', 'Raja Ampat', 'Sorong', 'Waisai', 'Resort',
       ...
       (1008, 'Sumatra Wildlife', 'Jungle Trek', 2700000, '3 days', 'Sumatra', 'Medan', 'Bukit Lawang', 'Lodge',
       ...
       (1009, 'Bromo Sunrise', 'Mountain Adventure', 2000000, '2 days', 'Bromo', 'Malang', 'Bromo', 'Hotel',
        'Climb Bromo', 'Sunrise View\nJeep Tour\nCrater Hike', 'Guide\nTransport\nBreakfast',
        'Meals\nPersonal expenses',
        'Day 1: Sunrise Tour | Early morning jeep to Bromo\nDay 2: Crater Hike | Hike to Bromo crater and return'),
       (1010, 'Labuan Bajo Leisure', 'Island Hopping', 3200000, '3 days', 'Labuan Bajo', 'Labuan Bajo', 'Padar Island',
        'Boat', 'Island hop', 'Padar Island\nKanawa Island\nSnorkeling', 'Boat\nMeals\nGuide',
        'Flights\nPersonal expenses',
